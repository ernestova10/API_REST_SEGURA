package com.es.ProyectoAPI_Segura.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth // Filtros para securizar diferentes endpoints de la aplicación
                                ...
                                .requestMatchers(HttpMethod.POST,"/hamburguesas/create").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.GET,"/hamburguesas/").authenticated()
                                .requestMatchers(HttpMethod.PUT,"/hamburguesas/{id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.DELETE,"/hamburguesas/{id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.POST,"/pedidos/").authenticated()
                                .requestMatchers(HttpMethod.GET,"/pedidos/historial/{perfil}").authenticated()
                                .requestMatchers(HttpMethod.GET,"/pedidos/admin/historial").hasRole("ADMIN")
